...
cells = [
    ...
    },
    {
        ...
        "outputs": [],
        "source": [
            "# @title ⚙️ SECTION 1: SYSTEM ENVIRONMENT, RUST TOOLCHAIN & REPO SETUP { display-mode: \"form\" }\n",
            "# ==============================================================================\n",
            ...
            "\n",
            "print(\"=\" * 80)\n",
            "print(\" 🚀 BƯỚC 1: CÀI ĐẶT RUST TOOLCHAIN & THIẾT LẬP REPOSITORY XIANGQI-RIM NATIVE\")\n",
            "print(\"=\" * 80)\n",
            "\n",
            "# 1. Kiểm tra GPU\n",
            "try:\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "variable_lr = 0.0005 # @param {\"type\":\"number\"}\n",
            "variable_samples = 5000000 # @param {\"type\":\"integer\"}\n",
            ...
            "print(\"=\" * 80)\n",
            "\n",
            "cmd = f\"DATASET='{dataset_arg}' OUTPUT='{OUTPUT_BIN}' EPOCHS={EPOCHS} SAMPLES={SAMPLES} RATE={LR} cargo run --release --example 108_sota_wdl_nnue_trainer\"\n",
