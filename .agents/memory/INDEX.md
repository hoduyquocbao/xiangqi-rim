...
- [`pain_points_20260812_v2.md`](file:///Users/hdqb/workspaces/xiangqi-rim/.agents/memory/pain_points_20260812_v2.md): Nhận diện & bóc gỡ 5 Lỗ Hổng Ngây Thơ (Pseudo-GPU Acceleration, GPU Batching vs Alpha-Beta Pruning, Gán ghép sai công trạng MVV-LVA/TT, macOS Zero-Copy vs Linux PCIe VRAM, Lẫn lộn 500 ván cờ vs 500 lần duyệt nút gốc).
- [`pain_points_20260812.md`](file:///Users/hdqb/workspaces/xiangqi-rim/.agents/memory/pain_points_20260812.md): Ràng buộc sắt bắt buộc: Immediate Live Yield ra stdout trong vòng lặp và Realtime Telemetry Monitoring (RAM RSS, CPU %, GPU Compute/VRAM %).
