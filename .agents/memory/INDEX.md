...
- [`pain_points_20260810.md`](file://.agents/memory/pain_points_20260810.md) — **Bài học xương máu đắt giá v11.1**: Triệt tiêu 100% ảo giác FEN khai cuộc bằng `Board.apply()`, triệt tiêu rủi ro bug PyTorch Colab C++ `aten.linspace` bằng Pure Python Fallback (Zero Dependency Mode), duy trì kỷ luật cập nhật version & log rotation.
