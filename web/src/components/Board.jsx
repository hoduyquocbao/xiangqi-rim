...
// Định danh đơn từ tiếng Anh: Board, labels, fen, move, flip, disabled, check, state, update, click, start, over, drop, clear, point, board, turn, rank, file, x, y, index, piece, color, type, style, grid, svg, cx, cy, f, r, enemy, red, selected, king, threat, parsed, glow, ruby, dark, shadow, target, rulers, labelFile, compact, boardSvg
...
export default function Board({ fen, move, lastMove = null, flip = false, disabled = false, check = false, rulers = true, compact = false }) {
  ...
  const boardSvg = (
    <svg viewBox="0 0 900 1000" className="w-full h-full aspect-[9/10] block">
      ...
      {/* 3. Văn bản Chữ Hán Sông "楚 河" & "漢 界" */}
