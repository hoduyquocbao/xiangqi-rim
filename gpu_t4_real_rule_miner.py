# === XIANGQI-R1 REAL RULE DATA MINER ENGINE (v11.1-JRCP5-BULLETPROOF) ===
...
# + DYNAMIC OPENING FEN SAMPLER (100% BOARD.APPLIED) + SIEVE DEDUP + ZERO-DEPENDENCY PURE PYTHON FALLBACK
